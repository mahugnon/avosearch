...
export async function getLawyerWorkQueue(lawyerId: string): Promise<WorkQueueItem[]> {
...
export async function getLawyerActionCount(lawyerId: string): Promise<number> {
