...
import { updateLawyerContractAction } from "@/lib/actions/lawyer-contract";
...
import {
  LawyerFieldReviewHeader,
  LawyerFieldReviewSidebar,
} from "@/components/lawyer/lawyer-field-review-sidebar";
import {
  FIELD_PILL_HEIGHT,
  useFieldAnchorPositions,
} from "@/components/lawyer/use-field-anchor-positions";
...
export function LawyerContractEditor({
  contractId,
  missionId,
  title,
  extractedText,
  ...
  function handleSave() {
    startTransition(async () => {
      ...
      const result = await updateLawyerContractAction({
        contractId,
        missionId,
            ...
            >
              <div className="min-w-0">
                {activeHighlight && previewSegments ? (
                  ...
                  <>
                    <ContractDocumentFromBody body={extractedText} mode="lawyer" />
