...
interface BarristerMissionsFiltersProps {
  filters: MissionListFilters;
  resultCount: number;
}

export function BarristerMissionsFilters({
  filters,
  resultCount,
}: BarristerMissionsFiltersProps) {
  const t = useTranslations("barrister.missions");
