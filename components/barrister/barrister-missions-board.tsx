...
import type { BoardColumnKey } from "@/lib/barrister/missions-board";
import {
  getVisibleBoardColumns,
  groupMissionsByBoardColumn,
} from "@/lib/barrister/missions-board";
import type { MissionListRow } from "@/lib/barrister/missions-list";

interface BarristerMissionsBoardProps {
...
export async function BarristerMissionsBoard({
  missions,
  locale,
  hasAnyMissions,
  visibleColumns,
}: BarristerMissionsBoardProps) {
                      ...
                      >
                        ...
                        <div className="mt-2 flex flex-wrap items-center gap-1.5">
                          ...
                          {isBarristerReviewDelivered(mission.status) && (
                            <BarristerReviewedBadge label={t("reviewedBadge")} className="text-[10px]" />
                          )}
