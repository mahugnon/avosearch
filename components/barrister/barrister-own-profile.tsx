import { MissionType, type BarristerProfile, type User } from "@prisma/client";
...
import type { BarristerProfileStats } from "@/lib/barrister/profile-stats";
import { cn } from "@/lib/utils";

type ProfileWithUser = BarristerProfile & {
  user: Pick<User, "name" | "email">;
};

interface BarristerOwnProfileProps {
  profile: ProfileWithUser;
  stats: BarristerProfileStats;
}
...
export async function BarristerOwnProfile({ profile, stats }: BarristerOwnProfileProps) {
  const t = await getTranslations("barrister");
  const tm = await getTranslations("barrister.missions.type");
